...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#d8e6ff] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
          <main class="">
            ...
            @if (Route::has('login'))
                <nav class="bg-white flex flex-col items-center justify-end gap-4 p-10 rounded-md shadow-lg " >
